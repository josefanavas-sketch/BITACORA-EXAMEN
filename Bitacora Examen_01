...
![Pantalla de Bienvenida - Bosque](imagen.1.jpg)[cite: 1]
...
![Mapa del Laberinto Activo](imagen.2.png)[cite: 1]
...
![Transición Óptica - Piglet](imagen.3.)[cite: 1]

* **Fondo de Winnie de Pooh (Estado 3):**[cite: 1]
![Grilla Interactiva - Pooh](imagen.4.png)[cite: 1]
